...
const LoginPage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 px-4 pb-10 pt-24 sm:px-6 sm:pb-16 sm:pt-28 lg:px-10">
      ...
      <div className="absolute left-[-120px] top-24 -z-10 h-[420px] w-[420px] rounded-full bg-fuchsia-500/15 blur-[140px]" />
      <div className="absolute bottom-[-120px] right-[-40px] -z-10 h-[420px] w-[420px] rounded-full bg-cyan-500/15 blur-[140px]" />
